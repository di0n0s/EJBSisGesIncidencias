...
public class TestEJB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Empleados e = new Empleados("cbravo","mas254","Carlos Bravo Donosti","+34688454289");
            if(miGestor.existeEmpleado(e.getUsername())){
                out.println("<p>No se ha podido insertar "+e.getUsername()+": Ya existe en la BBDD</p>");
            } else{
                miGestor.insertEmpleado(e);
